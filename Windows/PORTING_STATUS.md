...
| Additional usage providers | provider implementations and tests | Partial | Gemini CLI local JSON/JSONL usage is complete beside Codex; Cursor and Copilot are next. |
